...
class Configuracion:
    ...
    Icodigo = "3"
    Idescripcion = "Prueba automatizada para la descripción en centros de costo"
    Mdescripcion = "Prueba automatizada para la modificacio en centros de costo"
    Iobservacion1 = "Prueba automatizada para la observación en centros de costo"
    Iobservacion2 = "Prueba automatizada para la observación en centros de costo"
    Iobservacion3 = "Prueba automatizada para la observación en centros de costo"
    Mobservacion1 = "Prueba automatizada para la modificacio en centros de costo"
    Mobservacion2 = "Prueba automatizada para la modificacio en centros de costo"
    Mobservacion3 = "Prueba automatizada para la modificacio en centros de costo"
    ...
    texto_buscador = "//div[text()='Centros Costo']"
    Iopcionbuscador = "Centros Costo"
