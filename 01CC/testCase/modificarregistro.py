...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='3']")))
        ...
        try:
            ...
            Log().info("Se hace el cambio de pestaña Obsrvaciones para continuar con la modificación del registro")

        except Exception as e:
            Log().error("No se dió click el botón observaciones, validar que la acción anterior haya finalizado, que el xpath sea el correcto o que la página no presente lentitud")
            time.sleep(3)
            timeStrmap = time.strftime('%Y%m%d_%H_%M_%S')
            img_name = os.path.join(img_path, "%s.png" % str(timeStrmap))
            Log().info(message=" Captura: %s  screen：%s" % (img_path, os.path.split(img_name)[1]))
        ...
        try:
            ...
            Log().info(" Se modifica el contenido del campo Observación 1 ")
        ...
        try:
            ...
            Log().info(" Se modifica el contenido del campo Observación 2 ")
        ...
        try:
            ...
            Log().info(" Se modifica el contenido del campo Observación 3 ")
