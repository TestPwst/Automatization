...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        Registro2 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='Test1']")))
        ...
        Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='Test2']")))
        ...
        Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='Test3']")))
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Arquitectura de Producto.")
            time.sleep(2)
