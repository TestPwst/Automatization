...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            Log().error("No se encontró el campo codigo, revise si el xpath sigue siendo el mismo, revise la accion anterior si el xpath es el correcto o el tiempo de la accion")
            time.sleep(2)
            timeStrmap = time.strftime('%Y%m%d_%H_%M_%S')
            img_name = os.path.join(img_path, "%s.png" % str(timeStrmap))
            Log().info(message=" Captura: %s  screen：%s" % (img_path, os.path.split(img_name)[1]))
        ...
        try:
            ...
            Log().info(" Se modifica el codigo alternativo del registro.")
        ...
        try:
            ...
            Log().info(" Se modifica el codigo GLN del registro.")
        ...
        try:
            ...
            Log().info(" Se modifica la descripción del registro.")
        ...
        try:
            ...
            Log().info(" Se modifica el descuento del registro.")
        ...
        try:
            ...
            Log().info(" Se modifica el recargo del registro.")
