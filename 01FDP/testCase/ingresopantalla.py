...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            formasdepago = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='formaspago']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de formas de pago")
        ...
        try:
            ...
            self.assertEqual("FORMAS DE PAGO", Pantalla, "La pantalla ejecutada es correcta")
        ...
        # Reacomodar registros

        try:
            Acomodoregistro = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_codigo)))
            Acomodoregistro.click()
            time.sleep(1)
            Acomodoregistro.click()
            time.sleep(1)
