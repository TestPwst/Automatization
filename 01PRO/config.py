...
class Configuracion:
    ...
    Mdescripcion = "Prueba Cambio"
    Iobservacion1 = "Prueba automatizada para la observación"
    Mobservacion1 = "Prueba automatizada para la modificacion de la automatizacion"
    ...
    texto_buscador = "//div[text()='Proyectos']"
    Iopcionbuscador = "Proyectos"
    ...
    ayuda_cliente = "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[10]/div[2]/ui-container/ui-row/ui-tabstrip/div/div[2]/ui-container/ui-row[3]/ui-lookup/span[1]"
    campo_cerrado = "//input[@type = 'checkbox' and contains(@id, 'cerrado_checkbox')]"

    btn_observaciones = "//button[contains(@id, 'Observaciones_tabitem')]"
    campo_observaciones1 = "//textarea[contains(@id, 'observacion_element')]"
