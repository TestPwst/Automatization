...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        Registro2 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='PRO01']")))
        ...
        try:
            ...
            Refresca4.click()
            Log().info(" Se presiona el boton 'Refrescar', para validar que el registro ha sido eliminado")
            time.sleep(2)
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Proyectos.")
            time.sleep(2)
