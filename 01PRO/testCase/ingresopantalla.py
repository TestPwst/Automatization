...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Proyectos = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='proyectos']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Proyectos")
        ...
        try:
            ...
            self.assertEqual("PROYECTOS", Pantalla, "La pantalla ejecutada es correcta")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='PRO01']")
