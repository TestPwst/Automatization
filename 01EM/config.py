...
class Configuracion:
    ...
    Icodigo = "Codigoentidadmulti01"
    Icodigoalter = "Codigoalternativo001"
    Idescripcion = "Prueba automatizada del campo descripción EM"
    Mcodigoalter = "Cambioalternativo001"
    Mdescripcion = "Prueba automatizada de la Modificación del campo descripción EM"
    ...
    texto_buscador = "//div[text()='Entidades Multiproposito']"
    Iopcionbuscador = "Entidades Multiproposito"
