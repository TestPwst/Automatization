...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            EntidadesMulti = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='_tablas_enitdades']")))

            action = ActionChains(self.driver)
            action \
                .move_to_element(EntidadesMulti) \
                .pause(0) \
                .release()
            action.perform()

            Entidadesm = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='entidades']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Entidades Multiproposito")
        ...
        try:
            ...
            self.assertEqual("ENTIDADES MULTIPROPOSITO", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Entidades Multiproposito.")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='Codigoentidadmulti01']")
