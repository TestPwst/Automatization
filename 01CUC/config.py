...
class Configuracion:
    ...
    Idescripcion = "Prueba  automatizada para validar campo descripción de clasificación cuentas en la versión PWST 2.0"
    Mdescripcion = "Prueba automatizada para validar campo modificacio de clasificación cuentas en la versión PWST 2.0"
    ...
    texto_buscador = "//div[text()='Clasificaciones de cuentas contables']"
    Iopcionbuscador = "Clasificaciones de cuentas contables"
