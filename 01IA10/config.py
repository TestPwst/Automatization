...
class Configuracion:
    ...
    Icodigo = "CodigoTestingPrueba1"
    Idescripcion = "Esto es un prueba automatizada para validar la descripcion de informacion de articulo 10 para PWST 2"
    Mdescripcion = "Esto es un prueba automatizada para validar la modificacio de informacion de articulo 10 para PWST 2"
    ...
    texto_buscador = "//div[text()='Informacion de Articulo10']"
    Iopcionbuscador = "Informacion de Articulo10"
