...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Procedimientoevento = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='procedimientosevento']")))

            action = ActionChains(self.driver)
            action \
                .click(Procedimientoevento) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de PROCEDIMIENTOS DE EVENTO")
        ...
        try:
            ...
            self.assertEqual("PROCEDIMIENTOS DE EVENTO", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Procedimientos de Evento")
        ...
        try:
            ...
            Registrorepetido = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='"+Configuracion.NomNegocio+"']")))
            self.wait = WebDriverWait(self.driver, 60)
