...
class Configuracion:
    ...
    Iarticulo = "FA01001"
    Iarticuloabonif = "FA01002"
    Marticulo = "FA01003"
    Marticuloabonif = "FA01004"

    Icantidadabonificar = "0.05"
    Icantidadenbonificacion = "10"
    Mcantidadabonificar = "1"
    Mcantidadenbonificacion = "20"
    Itopedescuento1 = "100"
    Itopedescuento2 = "100"
    ...
    etiqueta_grupoadhoc = "//div[contains(@id, 'grupopoliticaadhoc_label_element')]"
    ...
    ayuda_grupoadhoc = "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[10]/div[2]/ui-container/ui-row/ui-tabstrip/div/div[2]/ui-container/ui-row[3]/span/ui-container/ui-row[2]/ui-lookup/span[1]"
    ...
    etiqueta_articuloabonificar = "//div[contains(@id, 'articulobonificacion_label_element')]"
    etiqueta_cantidadabonificar = "//div[contains(@id, 'cantidadabonificar_label_element')]"
    etiqueta_cantidadenbonificacion = "//div[contains(@id, 'cantidadenbonificacion_label_element')]"
    ...
    campo_articulo = "//input[@type = 'text' and contains(@id, 'articulo_element')]"
    campo_articuloabonificar = "//input[@type = 'text' and contains(@id, 'articulobonificacion_element')]"
    campo_cantidadabonificar = "//input[@type = 'text' and contains(@id, 'cantidadabonificar_element')]"
    campo_cantidadenbonificacion = "//input[@type = 'text' and contains(@id, 'cantidadenbonificacion_element')]"
