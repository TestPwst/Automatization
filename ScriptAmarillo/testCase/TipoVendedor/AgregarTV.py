...
class agregarTV:
    ...
    def agregarTV(self):
        ...
        try:
            ...
            self.assertEqual("TIPOS DE VENDEDOR : PROPIEDADES", Crea, "La pantalla ejecutada es correcta")
        ...
        try:
            Ccodigo = self.wait.until(conditions.visibility((By.XPATH, Configuracion.campo_codigoTV)))
            Ccodigo.send_keys(Configuracion.IcodigoTV)
        ...
        try:
            ...
            Ccodigousuario.send_keys(Configuracion.IcodigousuarioTV)
        ...
        try:
            ...
            Ccodigoalter.send_keys(Configuracion.IcodigoalterTV)
        ...
        try:
            ...
            Cdescripcion.send_keys(Configuracion.IdescripcionTV)
