...
class EliminarOBD:
    ...
    def EliminarOBD(self):
        ...
        Registro2 = self.driver.find_element(By.XPATH, "/html/body/div[3]/div[2]/ui-container/ui-window/div[10]/div[2]/ui-container/ui-row[3]/ui-listview/div/div/div[2]/div/div")
        ...
        try:
            ...
            Refresca4.click()
            Log().info(" Se presiona el boton 'Refrescar', para verificar que el registro ha sido eliminado.")
            time.sleep(5)
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Objetivos Diarios.")
            time.sleep(2)
