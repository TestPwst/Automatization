...
class ModificarCLV2:
    ...
    def ModificarCLV2(self):
        ...
        try:
            ...
            Ccodigoalter.clear()
            Ccodigoalter.send_keys(Configuracion.McodigoalterCLV2)
        ...
        try:
            ...
            Ccodigousuario.send_keys(Configuracion.McodigousuarioCLV2)
        ...
        try:
            ...
            Cdescripcion.clear()
            Cdescripcion.send_keys(Configuracion.MdescripcionCLV2)
