...
class ModificarTPU:
    ...
    def ModificarTPU(self):
        ...
        Registro = self.driver.find_element(By.XPATH, "//span[text()='CodigoTesting1']")
        ...
        try:
            Ccodigoalter = self.wait.until(conditions.visibility((By.XPATH, Configuracion.campo_codigo_alterTPU)))
            Ccodigoalter.clear()
            Ccodigoalter.send_keys(Configuracion.McodigoalterTPU)
        ...
        try:
            Cdescripcion = self.wait.until(conditions.visibility((By.XPATH, Configuracion.campo_descripcionTPU)))
            Cdescripcion.clear()
            Cdescripcion.send_keys(Configuracion.MdescripcionTPU)
