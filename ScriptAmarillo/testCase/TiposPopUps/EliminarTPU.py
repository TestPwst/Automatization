...
class EliminarTPU:
    ...
    def EliminarTPU(self):
        ...
        Registro2 = self.driver.find_element(By.XPATH, "//span[text()='CodigoTesting1']")
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Tipos PopUp.")
            time.sleep(2)
