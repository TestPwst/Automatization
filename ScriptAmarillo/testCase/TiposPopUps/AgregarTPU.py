...
class AgregarTPU:
    ...
    def AgregarTPU(self):
        ...
        try:
            Ccodigo = self.wait.until(conditions.visibility((By.XPATH, Configuracion.campo_codigoTPU)))
            Ccodigo.send_keys(Configuracion.IcodigoTPU)
        ...
        try:
            ...
            Ccodigoalter.send_keys(Configuracion.IcodigoalterTPU)
        ...
        try:
            ...
            Cdescripcion.send_keys(Configuracion.IdescripcionTPU)
