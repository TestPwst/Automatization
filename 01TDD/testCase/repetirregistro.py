...
class repetirregistro:
    ...
    def repetirregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            Log().error(
                "No se dió click al botón Refrescar, validar que la acción anterior haya finalizado,que el xpath sea el correcto o que la página no presente lentitud o si ya existe el registro ya creado")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE DISTRIBUCIÓN : PROPIEDADES", Crea, "La pantalla ejecutada es correcta")
