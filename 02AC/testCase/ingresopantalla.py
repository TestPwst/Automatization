...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Authcredito = self.wait.until(conditions.visibility((By.XPATH, "//div[@id='autograles']")))
            action = ActionChains(self.driver)
            action \
                .click(Authcredito) \
                .pause(0) \
        ...
        try:
            ...
            self.assertEqual("AUTORIZACIONES DE CRÉDITO", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Autorizaciones de crédito.")
        ...
        try:
            ...
            Registrorepetido = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='mabcecgut']")))
            self.wait = WebDriverWait(self.driver, 60)
