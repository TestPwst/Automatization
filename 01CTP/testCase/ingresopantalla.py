...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            CustomProperties = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='customproperties']")))

            action = ActionChains(self.driver)
            action \
                .click(CustomProperties) \
                .pause(0) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Custom Properties")
        ...
        try:
            ...
            self.assertEqual("CUSTOM PROPERTIES", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Custom Properties.")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='Codigopru1']")
