...
class Configuracion:
    ...
    Icodigo = "Codigopru1"
    Idescripcion = "Prueba Automatizada del campo descripción CP PWST 2.0"
    Mdescripcion = "Prueba Automatizada de la Modi campo descripción CP PWST 2.0"
    ...
    texto_buscador = "//div[text()='Custom Properties']"
    Iopcionbuscador = "Custom Properties"
    ...
    etiqueta_aplicablea = "//div[contains(@id, 'aplica_label_element')]"
    ...
    campo_aplicablea = "//div[contains(@id, 'aplica_select')]"
