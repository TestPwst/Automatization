...
class Configuracion:
    ...
    Iobjetivocantidad = "10"
    Iobjetivocobertura = "5"
    Mobjetivocantidad = "12"
    Mobjetivocobertura = "7"
    ...
    etiqueta_tipounidad = "//div[contains(@id, 'tipounidad_label_element')]"
    etiqueta_objetivocantidad = "//div[contains(@id, 'objetivocantidad_label_element')]"
    etiqueta_objetivocobertura = "//div[contains(@id, 'objetivocobertura_label_element')]"
    ...
    campo_tipounidad = "//div[contains(@id, 'tipounidad_select')]"
    campo_objetivocantidad = "//input[@type = 'text' and contains(@id, 'objetivocantidad_element')]"
    campo_objetivocobertura = "//input[@type = 'text' and contains(@id, 'objetivocobertura_element')]"
