...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Rubrostock = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='rubrosstock']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Rubro de Stock")
        ...
        try:
            ...
            self.assertEqual("RUBROS DE STOCK", Pantalla, "La pantalla ejecutada es correcta")
