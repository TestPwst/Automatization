...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            CatFis = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='categoriasfiscales']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de categorias fiscales")
        ...
        try:
            ...
            self.assertEqual("CATEGORÍAS FISCALES", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Categorías Fiscales.")
