...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        Registro2 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='MAB20']")))
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Programaciones Scheduler.")
            time.sleep(2)
