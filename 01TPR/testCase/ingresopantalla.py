...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Tiposregional = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposregionalx']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de tipos regional")
        ...
        try:
            ...
            self.assertEqual("TIPOS REGIONAL", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es TIPO DE REGIONAL")
