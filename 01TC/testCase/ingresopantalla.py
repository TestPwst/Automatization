...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TiposCliente = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposcliente']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Tipos de Cliente")
        ...
        try:
            ...
            self.assertEqual("TIPOS CLIENTE", Pantalla, "La pantalla ejecutada es correcta")
