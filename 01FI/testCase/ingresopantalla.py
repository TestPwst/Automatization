...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Impuestos = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='_tablas_imp']")))

            action = ActionChains(self.driver)
            action \
                .move_to_element(Impuestos) \
                .pause(0) \
                .release()
            action.perform()

            Familias = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='familiaimpuestos']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Familias de Impuestos")
        ...
        try:
            ...
            self.assertEqual("FAMILIAS DE IMPUESTOS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Familias de Impuestos")
