...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Rubroscaja = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='rubroscaja']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Rubros de Caja")
        ...
        try:
            ...
            self.assertEqual("RUBROS DE CAJA", Pantalla, "La pantalla ejecutada es correcta")
