...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Sabores = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='sabores']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Sabores")
        ...
        try:
            ...
            self.assertEqual("SABORES", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es SABORES")
