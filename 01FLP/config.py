...
class Configuracion:
    ...
    Icodigo = "FLP1"
    Idescripcion = "Prueba Automatizada del campo descripción Familias LP"
    Mdescripcion = "Prueba Automatizada de la Modificación del campo descripción Familias LP"
    ...
    texto_buscador = "//div[text()='Familias LP']"
    Iopcionbuscador = "Familias LP"
