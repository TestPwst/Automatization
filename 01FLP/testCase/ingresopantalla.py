...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            FamiliasLp = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='familiaslp']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Clasificaciones de Familias LP")
        ...
        try:
            ...
            self.assertEqual("FAMILIAS DE LISTA DE PRECIOS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Familias LP.")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='FLP1']")
