...
class Configuracion:
    ...
    Icodigo = "Test"
    Icodigoalter = "Test"
    Idescripcion = "Prueba automatizada del campo descripción tipo exclusividad1"
    Mcodigoalter = "CambioTest"
    Mdescripcion = "Prueba automatizada del campo modificación tipo exclusividad"
    ...
    texto_buscador = "//div[text()='Tipos Exclusividad']"
    Iopcionbuscador = "Tipos Exclusividad"
