...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            InfArticulo2 = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='infoarticulo2']")))
            ...
            Log().info(" Abre la pantalla de Información del Artículo 2")
        ...
        try:
            ...
            self.assertEqual("INFORMACIÓN DE ARTÍCULO2", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es INFORMACIÓN DE ARTÍCULO 2.")
