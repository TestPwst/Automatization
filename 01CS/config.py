...
class Configuracion:
    ...
    Iemail = "pruebapwst2@powerstreet.com.mx"
    Inomnegocio = "Prueba Automatizada Campo Nombre Negocio"
    Mnomnegocio = "Prueba Automatizada de la Modificación Campo Nombre Negocio"
    ...
    texto_buscador = "//div[text()='Contactos']"
    Iopcionbuscador = "Contactos"
    ...
    etiqueta_email = "//div[contains(@id, 'email_label_element')]"
    etiqueta_nomnegocio = "//div[contains(@id, 'nombre_label_element')]"
    etiqueta_activo = "//label[contains(@id, 'activo_label')]"
    campo_email = "//input[@type = 'text' and contains(@id, 'email_element')]"
