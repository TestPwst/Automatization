...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Contactos = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='contactossch']")))
        ...
        try:
            ...
            self.assertEqual("CONTACTOS SCHEDULER", Pantalla, "La pantalla ejecutada es correcta")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='pruebapwst2@powerstreet.com.mx']")
