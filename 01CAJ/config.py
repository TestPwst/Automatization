...
class Configuracion:
    ...
    Icodigo = "Codigo1234"
    Idescripcion = "Prueba automatizada del campo descripción Cajas PWST 2.0"
    Mdescripcion = "Prueba automatizada de la Modificación del campo descripción Cajas PWST 2.0"
    ...
    texto_buscador = "//div[text()='Cajas']"
    Iopcionbuscador = "Cajas"
