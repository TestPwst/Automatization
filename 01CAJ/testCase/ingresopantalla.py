...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Cajas = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='cajas']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Cajas")
        ...
        try:
            ...
            self.assertEqual("CAJAS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Cajas")
