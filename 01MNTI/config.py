...
class Configuracion:
    ...
    Icodigo = "CODIGO-INICIAL123456"
    Idescripcion = "Esta es una prueba de automatizacion para el camp descripcion de Power Street 2.0 de la ventana MNTI"
    Mdescripcion = "Esta es una prueba de MODIFICACION para el camp descripcion de Power Street 2.0 de la ventana MNTI 1"
    ...
    texto_buscador = "//div[text()='Motivos de no toma de inventario']"
    Iopcionbuscador = "Motivos de no toma de inventario"
    ...
    etiqueta_existenciacero = "//label[contains(@id, 'existenciacero_label')]"
    ...
    campo_existenciacero = "//input[@type = 'checkbox' and contains(@id, 'existenciacero_checkbox')]"
