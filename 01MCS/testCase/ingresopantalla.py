...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Motivosconfstock = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='motivosconfstock']")))

            action = ActionChains(self.driver)
            action \
                .click(Motivosconfstock) \
                .release()
            action.perform()
        ...
        try:
            ...
            self.assertEqual("MOTIVOS CONFIRMACIÓN DE STOCK", Pantalla, "La pantalla ejecutada es correcta")
