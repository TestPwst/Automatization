...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Planometrias = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='planometrias']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Planometrias")
        ...
        try:
            ...
            self.assertEqual("PLANOMETRÍAS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Planometrias.")
