...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            ClasArt4 = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='clasart4']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de clasificación de artículos 4")
        ...
        try:
            ...
            self.assertEqual("CLASIFICACIÓN DE ARTÍCULO 4", Pantalla, "La pantalla ejecutada es correcta")
