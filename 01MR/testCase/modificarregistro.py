...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        try:
            Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGO1234']")))
            time.sleep(1)
            Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGO1234']")))
        ...
        try:
            ...
            registro_trechazo = self.wait.until(conditions.visibility((By.XPATH, "//li[text()='Total']")))
