...
class Configuracion:
    ...
    Icodigo = "CODIGO1234"
    Idescripcion = "Esto es una prueba para la automatizacion de la ventana Motivos de Rechazo de Power Street 2.0 campo"
    Mdescripcion = "Esto es una prueba para la modificacion de la ventana Motivos de Rechazo de Power Street 2.0 cam des"
    ...
    texto_buscador = "//div[text()='Motivos de rechazo']"
    Iopcionbuscador = "Motivos de rechazo"
    ...
    etiqueta_trechazo = "//div[contains(@id, 'tiporechazo_label_element')]"
    ...
    campo_trechazo = "//div[contains(@id, 'tiporechazo_select')]"
