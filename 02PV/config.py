...
class Configuracion:
    ...
    Icantidadabonificar = "30"
    Icantidadenbonificacion = "50"
    Mcantidadabonificar = "50"
    Mcantidadenbonificacion = "70"
    Itopedescuento1 = "100"
    Itopedescuento2 = "100"
    ...
    etiqueta_grupoabonificar = "//div[contains(@id, 'grupobonificacion_label_element')]"
    ...
    campo_grupoabonificar = "//input[@type = 'text' and contains(@id, 'grupobonificacion_element')]"
