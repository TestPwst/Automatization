...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            registro_buscador = self.wait.until(conditions.visibility((By.XPATH, "//div[text()='Clasificación de articulos2']")))
        ...
        try:
            ...
            self.assertEqual("CLASIFICACIÓN DE ARTÍCULO 2", Pantalla, "La pantalla ejecutada es correcta")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='A10']")
