...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Opciones2 = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='showoptions']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Opciones")
        ...
        try:
            ...
            self.assertEqual("CONFIGURACIONES", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Opciones")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='PRU20']")
