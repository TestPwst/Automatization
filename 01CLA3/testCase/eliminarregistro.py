...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        Registro2 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='A10']")))
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Clasificacion Articulo.")
            time.sleep(2)
