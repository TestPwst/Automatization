...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            registro_buscador = self.wait.until(conditions.visibility((By.XPATH, "//div[text()='Clasificación de articulos3']")))
        ...
        try:
            ...
            self.assertEqual("CLASIFICACIÓN DE ARTÍCULO 3", Pantalla, "La pantalla ejecutada es correcta")
