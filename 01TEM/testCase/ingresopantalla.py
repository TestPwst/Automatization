...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TiposEmp = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposempaque']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Tipos de Empaque")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE EMPAQUE", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Tipos de Empaque.")
            time.sleep(3)
