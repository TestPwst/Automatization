...
class Configuracion:
    ...
    Icodigo = "CO12"
    Idescripcion = "Esta es una prueba de automatizacion para el campo descripcion de la ventana Tipos de Empaque de 2.0"
    Mdescripcion = "Esta es una prueba de MODIFICACION para el campo descripcion de la ventana Tipos de Empaque de 2.0"
    ...
    texto_buscador = "//div[text()='Tipos de empaque']"
    Iopcionbuscador = "Tipos de empaque"
