...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            Log().info("Se hace el cambio a la pestaña Restricción de Documento para continuar con la modificación del registro")
        ...
        try:
            ...
            Log().info(" Se presiona el boton 'Guardar', para guardar la modificación del regsitro de Restricción por Producto.")
            time.sleep(1)
