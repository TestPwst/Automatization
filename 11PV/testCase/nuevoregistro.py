...
class nuevoregistro:
    ...
    def nuevoregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            Log().info("Se hace el cambio a la pestaña Restricción de Producto para continuar con el registro nuevo")
        ...
        try:
            ...
            Log().info(" Se presiona el boton 'Nuevo', para crear un nuevo registro de Restricción de Producto.")
        ...
        try:
            ...
            Log().info(" Se presiona el boton 'Guardar', para guardar el registro de Restriccción por Producto.")
