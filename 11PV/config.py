...
class Configuracion:   
    ...
    btn_restxproducto = "//button[contains(@id, 'restxProducto_tabitem')]"
    btn_Nuevo_restxproducto = "//div[contains(@id, 'add_restriccionesproducto_element')]"
    btn_Elimina_restxproducto = "//div[contains(@id, 'remove_restriccionesproducto_element')]"
    etiqueta_tiporest = "//div[contains(@id, 'tiporestriccion_label_element')]"
    etiqueta_articulo = "//div[contains(@id, 'articulo_label_element')]"
    campo_tiporest = "//div[contains(@id, 'tiporestriccion_select')]"
    campo_articulo = "//input[@type = 'text' and contains(@id, 'articulo_element')]"
    btn_Guarda_restxproducto = "/html/body/div[3]/div[2]/ui-container/div/ui-window/div[10]/div[1]/ui-toolbar/div/span[1]/ui-toolbarbutton/div"
    selecciona = "//span[text()='Modifica C']"
    btn_cerrar_modal = "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[1]/div/span[4]"
    btn_error = "//div[contains(@id, 'tbPanelErrors_element')]"
    campo_moneda = "//input[contains(@id, 'moneda_element')]"
