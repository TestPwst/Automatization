...
class Configuracion:
    ...
    campo_checkopcionesavanzadas = "//input[@type = 'checkbox' and contains(@id, 'opcionesavanzadas_checkbox')]"
    campo_checkfechavencimiento = "//input[@type = 'checkbox' and contains(@id, 'opcionfechavencimiento_checkbox')]"
    campo_tipovencimiento = "//div[contains(@id, 'tipovencimiento_select')]"
    campo_plazo = "//input[@type = 'text' and contains(@id, 'diasplazo_element')]"
