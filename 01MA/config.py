...
class Configuracion:
    ...
    Icodigo = "CODIGO1234"
    Idescripcion = "Esta es una prueba de automatizacion del campo descripcion de la ventana Motivo Anulacion de Power S"
    Mdescripcion = "Esta es una prueba de MODIFICACION del campo descripcion de la ventana Motivo Anulacion de Power Str"
    ...
    texto_buscador = "//div[text()='Motivos Anulación']"
    Iopcionbuscador = "Motivos Anulación"
