...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TiposOficina = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposoficina']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Tipos Oficina")
        ...
        try:
            ...
            self.assertEqual("TIPO DE OFICINA", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Tipos de Oficina.")
            time.sleep(1)
