...
class Configuracion:
    ...
    Idescripcion = "Prueba automatizada del campo descripción en tipo de oficina en PWST 2"
    Mcodigousuario = "CambioTestingPrueba1"
    Mcodigoalter = "CambioTestingPrueba1"
    Mdescripcion = "Prueba automatizada del campo modificacio en tipo de oficina en PWST 2"
    ...
    texto_buscador = "//div[text()='Tipos de Oficina']"
    Iopcionbuscador = "Tipos de Oficina"
