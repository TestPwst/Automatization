...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Presupuesto = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='_tablas_presu']")))

            action = ActionChains(self.driver)
            action \
                .move_to_element(Presupuesto) \
                .pause(0) \
                .release()
            action.perform()

            Tipoprosupuesto = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tipopresupuesto']")))

            action = ActionChains(self.driver)
            action \
                .click(Tipoprosupuesto) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de tipos de Presupuesto")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE PRESUPUESTOS", Pantalla, "La pantalla ejecutada es correcta")
        ...
        try:
            ...
            if Registrorepetido.is_displayed():
                ...
                try:
                    Eliminaniveles = self.wait.until(conditions.clickable((By.XPATH, Configuracion.btn_Elimina_niveles)))
