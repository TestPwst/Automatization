...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TopesVenta = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='_cli_topevta']")))

            action = ActionChains(self.driver)
            action \
                .move_to_element(TopesVenta) \
                .pause(0) \
                .release()
            action.perform()

            CategCliente = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='categoriascliente']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Categorías Cliente")
        ...
        try:
            ...
            self.assertEqual("CATEGORÍAS CLIENTE", Pantalla, "La pantalla ejecutada es correcta")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='Codigo1234']")
            if Registrorepetido.is_displayed():
                ...
                try:
                    Confirma_Elimina = self.wait.until(
                        conditions.visibility((By.XPATH, Configuracion.btn_acepta_eliminar)))
