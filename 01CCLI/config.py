...
class Configuracion:
    ...
    Icodigo = "Codigo1234"
    Icodigoalter = "Codigoalternativo123"
    Idescripcion = "Prueba automatizada del campo descripción categorías clientes PWST 2.0"
    Mcodigoalter = "Cambioalternativo123"
    Mdescripcion = "Prueba automatizada de la modificación en descripción categorías clientes PWST 2.0"
    ...
    texto_buscador = "//div[text()='Categorías Cliente']"
    Iopcionbuscador = "Categorías Cliente"
