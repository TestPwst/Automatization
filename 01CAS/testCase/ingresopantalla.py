...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Clasifasientos = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='clasificacionesasientos']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Clasificaciones de Asientos")
        ...
        try:
            ...
            self.assertEqual("CLASIFICACIONES DE ASIENTOS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Clasificaciones de Asientos.")
