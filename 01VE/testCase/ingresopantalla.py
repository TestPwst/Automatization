...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Vendedor = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='vendedores']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Vendedores")
        ...
        try:
            ...
            self.assertEqual("VENDEDORES", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Vendedores")
        ...
        try:
            ...
            if Registrorepetido.is_displayed():
                ...
                try:
                    ...
                    Registrodocreparto = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='Recarga de Mercan solo HH']")))
                    self.wait = WebDriverWait(self.driver, 60)
                ...
                try:
                    Eliminadocreparto = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_Elimina_documentoreparto)))
                ...
                try:
                    self.wait = WebDriverWait(self.driver, 5)
                    Registrodocumentos = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='Recarga de Mercan solo HH']")))
                    self.wait = WebDriverWait(self.driver, 60)
                ...
                try:
                    Eliminadocumentos = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_Elimina_documento)))
                    Eliminadocumentos.click()
                    Log().info(" Se presiona el boton 'Eliminar', para eliminar el registro.")
                ...
                try:
                    Registro4 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='ZI20']")))
