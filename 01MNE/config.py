...
class Configuracion:
    ...
    Icodigo = "CódigoTesting001"
    Idescripcion = "Esto es un prueba automatizada para validar la descripcion de motivos de no encuestados en PWST 2.0"
    Mdescripcion = "Esto es un prueba automatizada para validar la modificacion de motivos de no encuestados en la version 2.0"
    ...
    texto_buscador = "//div[text()='Motivos de no encuestado']"
    Iopcionbuscador = "Motivos de no encuestado"
    ...
    etiqueta_motivo = "//label[contains(@id, 'habilitado_label')]"
    ...
    campo_motivo = "//input[@type = 'checkbox' and contains(@id, 'habilitado_checkbox')]"
