...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            LineasNegocio = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='lineasnegocio']")))
            ...
            Log().info(" Abre la pantalla de Lineas Negocio")
        ...
        try:
            ...
            self.assertEqual("LINEAS DE NEGOCIOS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Lineas Negocio")
            time.sleep(2)
