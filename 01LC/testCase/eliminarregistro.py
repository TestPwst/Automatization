...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        try:
            Registro3 = self.driver.find_element(By.XPATH, "//span[text()='"+Configuracion.Icodigo+"']")
            time.sleep(1)
            Registro3 = self.driver.find_element(By.XPATH, "//span[text()='"+Configuracion.Icodigo+"']")
        ...
        try:
            ...
            Refresca4.click()
            Log().info(" Se presiona el boton 'Refrescar', para validar si el registro ha sido eliminado.")
            time.sleep(2)
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Lineas Negocio.")
            time.sleep(2)
