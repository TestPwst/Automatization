...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TiposVendedor = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposvendedor']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info("Abre la pantalla Tipos Vendedor")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE VENDEDOR", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Tipos de Vendedor")
            time.sleep(1)
