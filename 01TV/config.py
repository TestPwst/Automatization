...
class Configuracion:
    ...
    Icodigo = "TDV12345678901234567"
    Icodigoalter = "CDUTV123456789012345"
    Icodigousuario = "CALT1234567890123456"
    Idescripcion = "Esto es una prueba de validacion para la automatizacion de la ventana Tipo de Vendedor de Power 2.0"
    Mcodigoalter = "123456789012ALTERCOD"
    Mdescripcion = "Esto es una prueba de validacion para la modificacion de la ventana Tipo de Vendedor de PWST 2.01234"
    Mcodigousuario = "123456789012CODIGOUS"
    ...
    texto_buscador = "//div[text()='Tipos de Vendedor']"
    Iopcionbuscador = "Tipos de Vendedor"
