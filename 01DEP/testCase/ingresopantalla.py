...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Deposito = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='depositos']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Depositos")
        ...
        try:
            ...
            self.assertEqual("DEPÓSITOS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Depositos")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='1000']")
