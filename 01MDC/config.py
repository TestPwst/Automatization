...
class Configuracion:
    ...
    texto_buscador = "//div[text()='Modos de cancelación']"
    Iopcionbuscador = "Modos de cancelación"
    ...
    etiqueta_TipoEntregA = "//div[contains(@id, 'layout_label_element')]"
    campo_tipoentrega = "//div[contains(@id, 'layout_select')]"
