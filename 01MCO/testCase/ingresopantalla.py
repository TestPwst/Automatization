...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Modelocobranza = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='modeloscobranza']")))

            action = ActionChains(self.driver)
            action \
                .click(Modelocobranza) \
                .release()
            action.perform()

            Log().info(" Abre la pantalla de modelos de cobranza")
        ...
        try:
            ...
            self.assertEqual("MODELOS DE COBRANZA", Pantalla, "La pantalla ejecutada es correcta")
