...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            PaquetesForm = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='paquetesformularios']")))
        ...
        try:
            ...
            Registrorepetido = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='"+Configuracion.Icantidadform+"']")))
            self.wait = WebDriverWait(self.driver, 60)
