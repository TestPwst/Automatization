...
class Configuracion:
    ...
    etiqueta_procevento = "//div[contains(@id, 'nombresalida_label_element')]"
    ...
    campo_procevento = "//textarea[contains(@id, 'nombresalida_element')]"
