...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            InfArticulo1 = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='infoarticulo']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Información de Articulo")
        ...
        try:
            ...
            self.assertEqual("INFORMACIÓN DE ARTÍCULO", Pantalla, "La pantalla ejecutada es correcta")
            time.sleep(2)
            Log().info(" La pantalla ejecutada es Información de Articulo.")
