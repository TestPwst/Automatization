...
class Configuracion:
    ...
    Icodigo = "12345"
    Icodigoalt = "PRUEREP2.0"
    Idescripcion = "Esto es una prueba automatizada para validar el campo descripcion de unidad en la version 2.0 de PWS"
    Irepartidos = "REP1"
    Mcodigoalt = "MODIREP2.0"
    Mdescripcion = "Esto es una prueba automatizada para validar el campo modificacio de unidad en la version 2.0 de PWS"
    Mrepartidor = "REP2"
    ...
    texto_buscador = "//div[text()='Zonas de Reparto']"
    Iopcionbuscador = "Zonas de Reparto"
    ...
    etiqueta_repartidor = "//*[contains(@id, 'repartidor_label_element')]"
    ...
    campo_repartidor = "//input[@type = 'text' and contains(@id, 'repartidor_element')]"
    ayuda_unidadnegocio = "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[10]/div[2]/ui-container/ui-row/ui-tabstrip/div/div[2]/ui-container/ui-row[5]/ui-lookup/span[1]"
    selecciona = "//span[text()='Modifica C']"
    btn_cerrar_modal = "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[1]/div/span[4]"
    btn_error = "//div[contains(@id, 'tbPanelErrors_element')]"
    btn_cerrar_ayuda = "/html/body/div[3]/div[2]/ui-container/div/ui-window/div[1]/div"
