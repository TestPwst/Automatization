...
class Configuracion:
    ...
    Idescripcion = "Prueba Automatizada del campo descripción Rutas PWST 2.0"
    Mdescripcion = "Prueba Automatizada de la Modificación del campo descripción Rutas PWST 2.0"
    ...
    texto_buscador = "//div[text()='Rutas']"
    Iopcionbuscador = "Rutas"
    ...
    etiqueta_inhibircarga = "//label[contains(@id, 'inhibircargarhistoricos_label')]"
    ...
    campo_inhibircarga = "//input[@type = 'checkbox' and contains(@id, 'inhibircargarhistoricos_checkbox')]"
