...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Rutas = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='rutas']")))
            ...
            Log().info(" Abre la pantalla de Rutas")
        ...
        try:
            ...
            self.assertEqual("RUTAS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Rutas.")
            time.sleep(1)
