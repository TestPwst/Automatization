...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Familias = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='familias']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Familias")
        ...
        try:
            ...
            self.assertEqual("FAMILIAS DE ARTÍCULOS", Pantalla, "La pantalla ejecutada es correcta")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='10']")
