...
class Configuracion:
    ...
    Iprocevento = "Evento Prueba"
    Mdescripcion = "Prueba Cambio Automatizado"
    Mprocevento = "Evento Prueba Cambio"
    ...
    etiqueta_procevento = "//div[contains(@id, 'procedimientoevento_label_element')]"
    ...
    campo_procevento = "//input[@type = 'text' and contains(@id, 'procedimientoevento_element')]"
