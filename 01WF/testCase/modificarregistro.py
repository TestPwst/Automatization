...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        try:
            Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGOWF12']")))
            time.sleep(1)
            Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGOWF12']")))
        ...
        try:
            ...
            registro_modbloqueo = self.wait.until(conditions.visibility((By.XPATH, "//li[text()='No Aplica']")))
