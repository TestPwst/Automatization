...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        try:
            Registro3 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGOWF12']")))
            time.sleep(1)
            Registro3 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGOWF12']")))
        ...
        try:
            Btiposdoc = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_tipodoc)))
            Btiposdoc.click()
        ...
        try:
            Eliminatipodoc = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_Elimina_tipodoc)))
        ...
        try:
            Registro5 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGOWF12']")))
