...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Grupos = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='grupos']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Grupos de Clientes")
        ...
        try:
            ...
            self.assertEqual("GRUPOS DE CLIENTES", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Grupos de Clientes")
