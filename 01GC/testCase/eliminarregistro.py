...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        try:
            Eliminasubgrupo = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_Elimina_subgrupo)))
            Eliminasubgrupo.click()
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Grupos Clientes.")
            time.sleep(2)
