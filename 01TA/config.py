...
class Configuracion:
    ...
    Idescripcion = "Esto es un prueba automatizada para validar la descripcion de tipos de agencia para PWST 2.0"
    Mcodigousuario = "CambioTestingPrueba1"
    Mcodigoalter = "CambioTestingPrueba1"
    Mdescripcion = "Esto es un prueba automatizada para validar la modificación de tipos de agencia para PWST 2.0"
    ...
    texto_buscador = "//div[text()='Tipos de Agencia']"
    Iopcionbuscador = "Tipos de Agencia"
    ...
    #btn_cerrar_error= "//button[contains(@id, '_element')]"
