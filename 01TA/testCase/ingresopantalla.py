...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TiposAgencia = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposagencia']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Tipos de Agencia")
        ...
        try:
            ...
            self.assertEqual("TIPO DE AGENCIAS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Tipos de Agencias.")
            time.sleep(1)
