...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            UbiDepositos = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='ubicacionesdeposito']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Ubicaciones en deposito")
        ...
        try:
            ...
            self.assertEqual("UBICACIONES EN DEPÓSITO", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Ubicaciones en deposito.")
