...
class Configuracion:
    ...
    Icodigo = "10000"
    Idescripcion = "Prueba del llenado del campo descripción ubicaciones de depositos"
    Mdescripcion = "Prueba de la modificación del campo descripción ubicaciones de depositos"
    ...
    texto_buscador = "//div[text()='Ubicaciones en depósito']"
    Iopcionbuscador = "Ubicaciones en depósito"
    ...
    etiqueta_denvio = "//label[contains(@id, 'detallarparaenvio_label')]"
    ...
    campo_denvio = "//input[@type = 'checkbox' and contains(@id, 'detallarparaenvio_checkbox')]"
