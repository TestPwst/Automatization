...
class Configuracion:
    ...
    Idepurador = "Prueba Automatizada"
    Ipassword = "Constrasena123"
    Mdescripcion = "Prueba Cambio Automatizado"
    Mqueryvariables = "Prueba Cambio Automatizado"
    Mdepurador = "Prueba Cambio Automatizado"
    Mpassword = "Constrasena12345"

    Iconfig = "Texto de prueba automatizadoo"
    Mconfig = "Texto de prueba cambio automatizadoo"
    ...
    etiqueta_depurador = "//div[contains(@id, 'nombresalida_label_element')]"
    ...
    campo_depurador = "//textarea[contains(@id, 'nombresalida_element')]"
    ...
    btn_archivoconfig = "//button[contains(@id, 'ArchiConfig_tabitem')]"
    campo_configuracion = "//textarea[contains(@id, 'configdepurador_element')]"
