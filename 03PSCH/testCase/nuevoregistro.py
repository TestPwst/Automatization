...
class nuevoregistro:
    ...
    def nuevoregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            Cdepurador.send_keys(Configuracion.Idepurador)
            Log().info(" Ingresa el Depurador del nuevo registro ")
        ...
        try:
            ...
            Log().info(" Se cambia a la Pestaña Archivo de Conficuración para continuar con el registro nuevo ")
        ...
        try:
            ...
            Cconfiguracion.send_keys(Configuracion.Iconfig)
            Log().info(" Ingresa la configuracion del nuevo registro ")
