...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='15']")))
        ...
        try:
            ...
            Calter.clear()
            Calter.send_keys(Configuracion.MalterCA)
        ...
        try:
            ...
            Cdescripcion.clear()
            Cdescripcion.send_keys(Configuracion.MdescripcionCA)
        ...
        try:
            ...
            registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='PM02']")))
        ...
        Registro2 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='20']")))
        ...
        try:
            ...
            CdescripcionSC.send_keys(Configuracion.MdescripcionSC)
        ...
        Registro3 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='prueba']")))
