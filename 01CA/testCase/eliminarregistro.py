...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        Registro5 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='15']")))
        ...
        Registro6 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='20']")))
        ...
        Registro7 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='15']")))
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Canales.")
            time.sleep(2)
