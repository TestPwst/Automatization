...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Canales = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='canales']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Canales")
        ...
        try:
            ...
            self.assertEqual("CANALES DE VENTA", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Canales")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='15']")
            if Registrorepetido.is_displayed():
                ...
                Registrorepetido1 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='20']")))

                try:
                    action = ActionChains(self.driver)
                    action \
                        .move_to_element(Registrorepetido1) \
                        .pause(0) \
                        .click(Registrorepetido1) \
                        .pause(0) \
                        .release()
                    action.perform()
                ...
                try:
                    EliminaSC = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_EliminaSC)))
                    EliminaSC.click()
                ...
                Registrorepetido2 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='15']")))
