...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Tipoproducto = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposprod']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de tipos de Producto")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE PRODUCTOS", Pantalla, "La pantalla ejecutada es correcta")
