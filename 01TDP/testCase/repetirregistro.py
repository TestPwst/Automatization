...
class repetirregistro:
    ...
    def repetirregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            self.assertEqual("TIPOS DE PRODUCTOS : PROPIEDADES", Crea, "La pantalla ejecutada es correcta")
        ...
        try:
            codigoalter = self.wait.until(
                conditions.visibility((By.XPATH, Configuracion.etiqueta_codigoalter))).text
