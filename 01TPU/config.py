...
class Configuracion:   
    ...
    Icodigoalter = "CODIGO-1234567890123"
    Idescripcion = "Esta es una prueba de automatizacion del campo descripcion de Power Street 2.0 de la ventana Tipo PU"
    Mcodigoalter = "CODIGOALT12345678900"
    Mdescripcion = "Esta es una prueba de MODIFICACION del campo descripcion de Power Street 2.0 de la ventana Tipos POP"
    ...
    texto_buscador = "//div[text()='Tipos PopUp']"
    Iopcionbuscador = "Tipos PopUp"
