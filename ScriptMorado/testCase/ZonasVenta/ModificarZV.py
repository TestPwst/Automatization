...
class ModificarZV:
    ...
    def ModificarZV(self):
        ...
        Registro = self.driver.find_element(By.XPATH, "//span[text()='10']")
        ...
        try:
            ...
            Ccodigoalter.clear()
            Ccodigoalter.send_keys(Configuracion.McodigoaltZV)
        ...
        try:
            ...
            Cdescripcion.clear()
            Cdescripcion.send_keys(Configuracion.MdescripcionZV)
            Log().info(" Se modifica el contenido del campo Descripcion")
            time.sleep(3)
