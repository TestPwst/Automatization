...
class AgregarZV:
    ...
    def AgregarZV(self):
        ...
        try:
            ...
            self.assertEqual("ZONAS DE VENTA : PROPIEDADES", Crea, "La pantalla ejecutada es correcta")
        ...
        try:
            Ccodigo = self.wait.until(conditions.visibility((By.XPATH, Configuracion.campo_codigoZV)))
            Ccodigo.send_keys(Configuracion.IcodigoZV)
        ...
        try:
            Ccodigoalter = self.wait.until(conditions.visibility((By.XPATH, Configuracion.campo_codigoaltZV)))
            Ccodigoalter.send_keys(Configuracion.IcodigoaltZV)
        ...
        try:
            Cdescripcion = self.wait.until(conditions.visibility((By.XPATH, Configuracion.campo_descripcionZV)))
            Cdescripcion.send_keys(Configuracion.IdescripcionZV)
        ...
        try:
            CUnidadNegocio = self.wait.until(conditions.visibility((By.XPATH, Configuracion.ayuda_unidadnegocioZV)))
        ...
        try:
            Bcuentascontables = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_ctacontZV)))
        ...
        try:
            Nuevo = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_nuevoctacontZV)))
            Nuevo.click()
            time.sleep(3)
        ...
        try:
            CTipoDoc = self.wait.until(conditions.visibility((By.XPATH, Configuracion.ayuda_tipodocZV)))
            CTipoDoc.click()
            time.sleep(5)
        ...
        try:
            CCtaCont = self.wait.until(conditions.visibility((By.XPATH, Configuracion.ayuda_ctacontZV)))
            CCtaCont.click()
            time.sleep(5)
        ...
        try:
            CCentroCosto = self.wait.until(conditions.visibility((By.XPATH, Configuracion.ayuda_centrocostoZV)))
            CCentroCosto.click()
            time.sleep(5)
        ...
        try:
            GuardarCtasCont = self.wait.until(conditions.visibility((By.XPATH, Configuracion.btn_aceptactacontZV)))
