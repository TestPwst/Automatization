...
class PantallaZV:
    ...
    def PantallaZV(self):
        ...
        ZonasVenta = self.driver.find_element(By.XPATH, "//*[@id='zonasventa']")
        ...
        try:
            ...
            time.sleep(3)
            Log().info(" Abre la pantalla de Zonas de Venta")
        ...
        try:
            ...
            self.assertEqual("ZONAS DE VENTA", Pantalla, "La pantalla ejecutada es correcta")
