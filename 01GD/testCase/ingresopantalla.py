...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Tiposdoc = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='_tablas_tdoc']")))

            action = ActionChains(self.driver)
            action \
                .move_to_element(Tiposdoc) \
                .pause(0) \
                .release()
            action.perform()

            Gruposdoc = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='gruposdocumento']")))
            ...
            Log().info(" Abre la pantalla de Grupos de Documentos")
        ...
        try:
            ...
            self.assertEqual("GRUPOS DE DOCUMENTOS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Grupos de Documentos.")
