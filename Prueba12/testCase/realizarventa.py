...
#             raise
        ...
        # Ingresa segundo articulo
        try:
            Articulo2 = self.wait.until(conditions.visibility((By.ID, Configuracion.id_articulos)))
            Articulo2.send_keys(Configuracion.articulo2)
            Log().info(" Escribe el segundo articulo")
            time.sleep(2)
        ...
        # Ingresa tercer articulo
        try:
            Articulo2 = self.wait.until(conditions.visibility((By.ID, Configuracion.id_articulos)))
            Articulo2.send_keys(Configuracion.articulo3)
            Log().info(" Escribe el tercer articulo")
            time.sleep(2)
        ...
        # Ingresa cuarto articulo
        try:
            Articulo2 = self.wait.until(conditions.visibility((By.ID, Configuracion.id_articulos)))
            Articulo2.send_keys(Configuracion.articulo4)
            Log().info(" Escribe el cuarto articulo")
            time.sleep(2)
