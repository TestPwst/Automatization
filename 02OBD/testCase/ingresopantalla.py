    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            action \
                ...
                .release()
            action.perform()
            ObjetivosDiarios = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='objetivosdiarios']")))
            action = ActionChains(self.driver)
            action \
                .click(ObjetivosDiarios) \
                .pause(0) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Objetivos Diarios")
        ...
        try:
            ...
            self.assertEqual("OBJETIVOS DIARIOS POR VENDEDOR", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Objetivos Diarios.")
        ...
        try:
            ...
            Registrorepetido = self.wait.until(conditions.visibility((By.XPATH, "/html/body/div[3]/div[2]/ui-container/ui-window/div[10]/div[2]/ui-container/ui-row[3]/ui-listview/div/div/div[2]/div/div")))
            self.wait = WebDriverWait(self.driver, 60)
