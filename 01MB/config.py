...
class Configuracion:
    ...
    Icodigo = "CODIGO-1234567890123"
    Icodigoalter = "CODIGO-ALTERNATIVO12"
    Idescripcion = "Esta es una prueba de automatizacion para el campo descripcion de la ventana Motivos de Bonificacion"
    Mcodigoalter = "12345-CODALTERNATIVO"
    Mdescripcion = "Esta es una prueba de MODIFICACION para el campo descripcion de la ventana Motivos de Bonificacion 2"
    ...
    texto_buscador = "//div[text()='Motivos de Bonificación']"
    Iopcionbuscador = "Motivos de Bonificación"
