...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            Log().error("No se click el botón Refrescar, validar que la acción anterior haya finalizado,"
        ...
        Registro2 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CódigoTestingPrueba1']")))
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Dias Credito Competencia.")
            time.sleep(2)
