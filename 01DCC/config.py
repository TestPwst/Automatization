...
class Configuracion:
    ...
    Idescripcion = "Esto es un prueba automatizada para validar la descripción de días crédito competencia en PWST 2.00"
    Mcodigoalter = "CambioCódigoTesting1"
    Mdescripcion = "Esto es un prueba automatizada para validar la modificación de días crédito competencia en PWST 2.00"
    ...
    texto_buscador = "//div[text()='Días Crédito Competencia']"
    Iopcionbuscador = "Días Crédito Competencia"
