...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            registro_listadistribucion = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='Equipo PMM']")))
        ...
        try:
            ...
            registro_contacto = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='ecastiglioni@assist.com.uy']")))
