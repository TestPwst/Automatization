...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Lenguajes = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='lenguajes']")))
            ...
            Log().info(" Abre la pantalla de Lenguajes")
        ...
        try:
            ...
            self.assertEqual("LENGUAJES", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es LENGUAJES.")
