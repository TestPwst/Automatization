...
class Configuracion:   
    ...
    Idescripcion = "Esto es un prueba automatizada para validar la descripcion de informacion de articulo 9 para PWST 2"
    Mdescripcion = "Esto es un prueba automatizada para validar la modificacion de informacion de articulo 9 para PWST 2"
    ...
    texto_buscador = "//div[text()='Informacion de Articulo9']"
    Iopcionbuscador = "Informacion de Articulo9"
