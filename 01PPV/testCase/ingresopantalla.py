...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            PpoliticasVenta = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='programacionPV']")))

            action = ActionChains(self.driver)
            action \
                .click(PpoliticasVenta) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Programación de Politicas de Venta")
        ...
        try:
            ...
            self.assertEqual("PROGRAMACIONES DE POLÍTICAS DE VENTA", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Programación de Politicas de Venta.")
