...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            EstadosExhibidor = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='estadosexhibidor']")))

            action = ActionChains(self.driver)
            action \
                .click(EstadosExhibidor) \
                .pause(0) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Estados Exhibidor")
        ...
        try:
            ...
            self.assertEqual("ESTADOS EXHIBIDOR", Pantalla, "La pantalla ejecutada es correcta")
