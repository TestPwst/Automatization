...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Vehiculos = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='vehiculo']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Vehiculos")
        ...
        try:
            ...
            self.assertEqual("VEHÍCULOS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Vehiculos.")
