...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        try:
            Registro3 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGO-12']")))
            time.sleep(1)
            Registro3 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='CODIGO-12']")))
        ...
        try:
            ...
            Refresca4.click()
            Log().info(" Se presiona el boton 'Refrescar', para verificar si el registro se elimino.")
            time.sleep(2)
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Tipo Politicas.")
            time.sleep(2)
