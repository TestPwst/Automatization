...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TiposPolitica = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tipospolitica']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Tipos de Politica")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE POLITICA", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Tipos de Politica")
            time.sleep(3)
