...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        Registro5 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='Test1']")))
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Arquitectura Cliente.")
            time.sleep(2)
