...
class Configuracion: 
    ...
    Idescripcion = "Esto es un prueba automatizada para validar la descripcion de tipos de identificacion para PWST 2.0"
    Mdescripcion = "Esto es un prueba automatizada para validar la modificación de tipos de identificacion para PWST 2.0"
    ...
    texto_buscador = "//div[text()='Tipos de Identificación']"
    Iopcionbuscador = "Tipos de Identificación"
    ...
    etiqueta_habilitado = "//*[contains(@id, 'habilitado_label_element')]"
    ...
    campo_habilitado = "//input[@type = 'checkbox' and contains(@id, 'habilitado_checkbox')]"
