...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TipoIdenti = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposidentificacion']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Tipo Identifiación")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE IDENTIFICACIÓN", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Tipo Identificación.")
            time.sleep(1)
