...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Perfiles = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='perfilescuenta']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Perfiles")
        ...
        try:
            ...
            self.assertEqual("PERFILES CUENTA", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Perfile de Cliente")
        ...
        try:
            ...
            if Registrorepetido.is_displayed():
                ...
                try:
                    ...
                    Log().error("No se encontró el botón tipos de documentos, revise si el xpath sigue siendo el mismo, revise la accion anterior si el xpath es el correcto o el tiempo de la accion")
                    timeStrmap = time.strftime('%Y%m%d_%H_%M_%S')
                    img_name = os.path.join(img_path, "%s.png" % str(timeStrmap))
                    Log().info(message=" Captura: %s  screen：%s" % (img_path, os.path.split(img_name)[1]))
                    self.driver.get_screenshot_as_file(img_name)
                ...
                try:
                    ...
                    Registro1 = self.wait.until(conditions.visibility((By.XPATH, "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[10]/div[2]/ui-container/ui-row/ui-tabstrip/div/div[3]/ui-container/ui-row/span/ui-container/ui-row[2]/ui-listview/div/div/div[2]/div/div[1]/div[1]/span")))
                    self.wait = WebDriverWait(self.driver, 60)

                    action = ActionChains(self.driver)
                    action \
                        .move_to_element(Registro1) \
                        .pause(0) \
                        .click(Registro1) \
                        .pause(0) \
                        .release()
                    ...
                    Log().error(
                        "No se encontró el registro 1, revise si el xpath sigue siendo el mismo, revise la accion anterior si el xpath es el correcto o el tiempo de la accion")
                    timeStrmap = time.strftime('%Y%m%d_%H_%M_%S')
                    img_name = os.path.join(img_path, "%s.png" % str(timeStrmap))
                    Log().info(message=" Captura: %s  screen：%s" % (img_path, os.path.split(img_name)[1]))
                    self.driver.get_screenshot_as_file(img_name)
                ...
                try:
                    self.wait = WebDriverWait(self.driver, 5)
                    Registro2 = self.wait.until(conditions.visibility((By.XPATH, "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[10]/div[2]/ui-container/ui-row/ui-tabstrip/div/div[3]/ui-container/ui-row/span/ui-container/ui-row[2]/ui-listview/div/div/div[2]/div/div[1]/div[1]/span")))
                    time.sleep(1)
                    Registro2 = self.wait.until(conditions.visibility((By.XPATH, "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[10]/div[2]/ui-container/ui-row/ui-tabstrip/div/div[3]/ui-container/ui-row/span/ui-container/ui-row[2]/ui-listview/div/div/div[2]/div/div[1]/div[1]/span")))
                    self.wait = WebDriverWait(self.driver, 60)
                    ...
                    Log().error(
                        "No se encontró el registro 2, revise si el xpath sigue siendo el mismo, revise la accion anterior si el xpath es el correcto o el tiempo de la accion")
                    timeStrmap = time.strftime('%Y%m%d_%H_%M_%S')
                    img_name = os.path.join(img_path, "%s.png" % str(timeStrmap))
                    Log().info(message=" Captura: %s  screen：%s" % (img_path, os.path.split(img_name)[1]))
                    self.driver.get_screenshot_as_file(img_name)
                ...
                try:
                    self.wait = WebDriverWait(self.driver, 5)
                    Registro3 = self.wait.until(conditions.visibility((By.XPATH, "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[10]/div[2]/ui-container/ui-row/ui-tabstrip/div/div[3]/ui-container/ui-row/span/ui-container/ui-row[2]/ui-listview/div/div/div[2]/div/div/div[1]/span")))
                    time.sleep(1)
                    Registro3 = self.wait.until(conditions.visibility((By.XPATH, "/html/body/div[3]/div[2]/ui-container/ui-window[2]/div[10]/div[2]/ui-container/ui-row/ui-tabstrip/div/div[3]/ui-container/ui-row/span/ui-container/ui-row[2]/ui-listview/div/div/div[2]/div/div/div[1]/span")))
                    self.wait = WebDriverWait(self.driver, 60)
                    ...
                    Log().error(
                        "No se encontró el registro 3, revise si el xpath sigue siendo el mismo, revise la accion anterior si el xpath es el correcto o el tiempo de la accion")
                    timeStrmap = time.strftime('%Y%m%d_%H_%M_%S')
                    img_name = os.path.join(img_path, "%s.png" % str(timeStrmap))
                    Log().info(message=" Captura: %s  screen：%s" % (img_path, os.path.split(img_name)[1]))
                    self.driver.get_screenshot_as_file(img_name)
