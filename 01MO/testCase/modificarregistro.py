...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        try:
            ...
            CSimbolo.clear()
            CSimbolo.send_keys(Configuracion.Msimbolo)
        ...
        try:
            ...
            CSimboloISO.clear()
            CSimboloISO.send_keys(Configuracion.MsimboloISO)
            time.sleep(2)
            timeStrmap = time.strftime('%Y%m%d_%H_%M_%S')
            img_name = os.path.join(img_path, "%s.png" % str(timeStrmap))
            Log().info(message=" Captura: %s  screen：%s" % (img_path, os.path.split(img_name)[1]))
        ...
        try:
            ...
            Ccambio.clear()
            Ccambio.send_keys(Configuracion.Mcambio)
        ...
        try:
            ...
            Cventa.clear()
            Cventa.send_keys(Configuracion.Mventa)
        ...
        try:
            ...
            Ccompra.clear()
            Ccompra.send_keys(Configuracion.Mcompra)
        ...
        try:
            ...
            Cfiscal.clear()
            Cfiscal.send_keys(Configuracion.Mfiscal)
        ...
        try:
            Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='prueba']")))
