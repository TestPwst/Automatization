...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TiposCheque = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposcheque']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Tipos de Cheques")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE CHEQUES", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Tipos de Cheques")
            time.sleep(1)
