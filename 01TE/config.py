...
class Configuracion:
    ...
    Icodigo = "CódigoAutomatizado01"
    Idescripcion = "Prueba automatizada para validar la descripción 01"
    Mdescripcion = "Prueba automatizada para validar la modificación 1"
    ...
    texto_buscador = "//div[text()='Tipos Ejecución EEV']"
    Iopcionbuscador = "Tipos Ejecución EEV"
