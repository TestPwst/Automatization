...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Sincronizacion = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='_tablas_sinc']")))
            ...
            Franjashorarias = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='franjashorarias']")))

            action = ActionChains(self.driver)
            action \
                .click(Franjashorarias) \
                .pause(0) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Franjas Horarias")
        ...
        try:
            ...
            self.assertEqual("FRANJAS HORARIAS", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Franjas Horarias.")
