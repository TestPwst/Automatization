...
class Configuracion:
    ...
    Icodigo = "CodigoTest"
    Icodigousuario = "CodigoTest1"
    Icodigoalter = "CodigoTest1"
    Idescripcion = "Prueba Automatizada"
    Mcodigousuario = "CambioTest1"
    Mcodigoalter = "CambioTest1"
    ...
    texto_buscador = "//div[text()='Clasificaciones2']"
    Iopcionbuscador = "Clasificaciones2"
    ...
    etiqueta_codigo_usuario = "//div[contains(@id, 'codusuario_label_element')]"
    ...
    campo_codigo_usuario = "//input[@type = 'text' and contains(@id, 'codusuario_element')]"
