...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Clasificaciones2 = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='clasificacionesvendedor2']")))

            action = ActionChains(self.driver)
            action \
                .click(Clasificaciones2) \
                .pause(0) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Clasificaciones 2")
        ...
        try:
            ...
            self.assertEqual("CLASIFICACIONES DE VENDEDORES2", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Clasifiaciones 2")
