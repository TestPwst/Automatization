...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Instantabla = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='instantaneastabla']")))
            ...
            Log().info(" Abre la pantalla de Instantanea Tabla")
        ...
        try:
            ...
            self.assertEqual("INSTANTÁNEA DE TABLA", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Instantanea Tabla.")
