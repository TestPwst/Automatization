...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            ModelosLiquidacion = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='modelosliquidacion']")))

            action = ActionChains(self.driver)
            action \
                .click(ModelosLiquidacion) \
                .pause(0) \
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Modelos Liquidación")
        ...
        try:
            ...
            self.assertEqual("MODELOS DE LIQUIDACIÓN", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Modelos Liquidacion.")
            time.sleep(2)
        ...
        try:
            ...
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[contains(text(), '( 3)')]")
            self.wait = WebDriverWait(self.driver, 60)
