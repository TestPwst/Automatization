...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            CategRiesgo = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='categoriasriesgos']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Categoria Riesgo")
        ...
        try:
            ...
            self.assertEqual("CATEGORIAS DE RIESGO", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Categoria Riesgo.")
        ...
        try:
            Registrorepetido = self.driver.find_element(By.XPATH, "//span[text()='10000']")
