...
class eliminarregistro:
    ...
    def eliminarregistro(self, conditions, Configuracion):
        ...
        Registro3 = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='10000']")))
        ...
        try:
            ...
            Refresca4.click()
            Log().info(" Se presiona el boton 'Refrescar', para veriicar si el registro fue eliminado.")
            time.sleep(2)
        ...
        try:
            ...
            Cierra_todo.click()
            Log().info(" Se presiona el boton 'Cerrar', para cerrar la pantalla de Categorias Riesgo.")
            time.sleep(2)
