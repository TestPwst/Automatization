...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        try:
            Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='Mabezihua']")))
        ...
        try:
            ...
            importelimite.send_keys(Configuracion. Mimportelimite)
        ...
        try:
            ...
            contrasena.clear()
            contrasena.send_keys(Configuracion.Mcontrasena)
        ...
        try:
            ...
            confirmacion.clear()
            confirmacion.send_keys(Configuracion.Mconfirmacion)
