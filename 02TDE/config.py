...
class Configuracion:
    ...
    Idescripcion = "En caso que si, Cuantas cajetillas necesitas?"
    Mcodigoalter = "Cambioalter1"
    Mdescripcion = "En caso que no, Cuantas cajetillas nos llevamos?"
    ...
    btn_validacion = "//button[contains(@id, 'Validacion_tabitem')]"
    etiqueta_desdevalor = "//div[contains(@id, 'desde_label_element')]"
    etiqueta_hastavalor = "//div[contains(@id, 'hasta_label_element')]"
    campo_desdevalor = "//input[@type = 'text' and contains(@id, 'desde_element')]"
    campo_hastavalor = "//input[@type = 'text' and contains(@id, 'hasta_element')]"
