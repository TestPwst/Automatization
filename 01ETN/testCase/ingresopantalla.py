...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            EntornoPdv = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='entornospdv']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Entornos PDV")
        ...
        try:
            ...
            self.assertEqual("ENTORNOS PUNTO DE VENTA", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es ENTORNOS PDV.")
            ...
            Log().error(
                "La pantalla ejecutada no es correcta, validar que la acción anterior haya finalizado,"
