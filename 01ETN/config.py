...
class Configuracion:
    ...
    Idescripcion = "Prueba automatizada del campo descripcion en PWST "
    Mcodigoalter = "CambioCódigoTesting1"
    Mdescripcion = "Modificación del campo descripción en PWST 2.0 p01"
    ...
    texto_buscador = "//div[text()='Entornos PDV']"
    Iopcionbuscador = "Entornos PDV"
