...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Popups = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='popupshh']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de PopUps")
        ...
        try:
            ...
            self.assertEqual("POPUPS HAND HELP", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es PopUps.")
            time.sleep(1)
