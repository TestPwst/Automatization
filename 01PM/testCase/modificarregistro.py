...
class modificarregistro:
    ...
    def modificarregistro(self, conditions, Configuracion):
        ...
        Registro = self.wait.until(conditions.visibility((By.XPATH, "//span[text()='20']")))
        ...
        try:
            ...
            registro_cargarrutas = self.wait.until(conditions.visibility((By.XPATH, "//li[text()='Una ruta']")))
