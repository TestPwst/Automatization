...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            TiposMatriz = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposmatriz']")))
            ...
            action \
                ...
                .release()
            action.perform()
            Log().info(" Abre la pantalla de Tipos de Matriz")
        ...
        try:
            ...
            self.assertEqual("TIPOS DE MATRIZ", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es Tipos de Matriz.")
            time.sleep(1)
