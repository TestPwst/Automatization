...
class Configuracion:
    ...
    Icodigo = "COD12345678901234567"
    Icodigousuario = "CODPRUEBA12345678901"
    Icodigoalter = "CODALT12345678901234"
    Idescripcion = "Esto es una prueba de automatizacion para la ventana Tipos de Matriz de PWST 2.0 campo descripcionnn"
    Mcodigousuario = "1234567890CODIGOUSUA"
    Mcodigoalter = "1234567890CODIGOALTE"
    Mdescripcion = "Esto es una prueba de modificacion para la ventana de Tipos de Matriz de PWST 2.0 campo descripcionn"
    ...
    texto_buscador = "//div[text()='Tipos de Matriz']"
    Iopcionbuscador = "Tipos de Matriz"
    ...
    etiqueta_codigo_usuario = "//*[contains(@id, 'codigousuario_label_element')]"
