...
class ingresopantalla:
    ...
    def ingresopantalla(self, conditions, Configuracion):
        ...
        try:
            ...
            Tiposcompañia = self.wait.until(conditions.visibility((By.XPATH, "//*[@id='tiposcompania']")))
        ...
        try:
            ...
            self.assertEqual("TIPO DE COMPAÑIA", Pantalla, "La pantalla ejecutada es correcta")
            Log().info(" La pantalla ejecutada es TIPO DE COMPAÑIA")
