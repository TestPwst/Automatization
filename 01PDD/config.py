...
class Configuracion:
    ...
    texto_buscador = "//div[text()='Porcentajes devolución']"
    Iopcionbuscador = "Porcentajes devolución"
    ...
    etiqueta_porcentaje = "//div[contains(@id, 'porcdevol_label_element')]"
    etiqueta_facturar =  "//div[contains(@id, 'porcfact_label_element')]"
    campo_porcentaje = "//input[@type = 'text' and contains(@id, 'porcdevol_element')]"
    campo_facturar = "//input[@type = 'text' and contains(@id, 'porcfact_element')]"
